import re
from smartetl.integrations.gne.utils import config, get_longest_common_sub_string
from lxml.html import HtmlElement
from smartetl.integrations.gne.defaults import TITLE_HTAG_XPATH, TITLE_SPLIT_CHAR_PATTERN
