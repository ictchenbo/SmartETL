...
from .extractor import ContentExtractor, TitleExtractor, TimeExtractor, AuthorExtractor, ListExtractor, MetaExtractor
...
class GeneralNewsExtractor:
    def extract(self,
        ...
        if ex_publish_time:
            result['publish_time'] = TimeExtractor().extract(element, publish_time_xpath=publish_time_xpath)
