...
from smartetl.integrations.unstructured.html_table import HtmlCell, HtmlRow, HtmlTable
from smartetl.integrations.unstructured.elements import (
    CompositeElement,
...
from smartetl.integrations.unstructured.utils import lazyproperty
