import re
from wikidata_filter.integrations.gne.utils import config, get_longest_common_sub_string
from lxml.html import HtmlElement
from wikidata_filter.integrations.gne.defaults import TITLE_HTAG_XPATH, TITLE_SPLIT_CHAR_PATTERN
